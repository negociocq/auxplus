    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Usar max-h-[100dvh] e deixar espaço para o teclado via padding
          "inset-x-0 bottom-0 top-auto max-h-[100dvh] translate-x-0 translate-y-0 overflow-y-auto rounded-t-2xl",
