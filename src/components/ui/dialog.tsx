    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Mobile: centralizado com espaço para teclado
          "inset-x-0 top-1/2 -translate-y-1/2 max-h-[80vh] translate-y-0 overflow-y-auto rounded-2xl",
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
          "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
          "data-[state=closed]:pointer-events-none",
          // Garante que há espaço mínimo para não ficar totalmente coberto
          "min-h-fit mx-4",
          // Desktop: modal centralizado
          "sm:inset-auto sm:left-[50%] sm:top-[50%] sm:bottom-auto sm:max-h-[90vh] sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:p-6 sm:mx-0",
